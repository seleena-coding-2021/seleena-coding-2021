...
-- 
#Currently
- taking CS 3200, Introduction to Databases, where we are learning all about databases (SQL, Python, Streamlit)
- taking DS 4200, Information Presentation & Visualization, where we are learning about creating visualizations and interpreting them (Python)
- taking MKTG 3402, Gaining Insights from Consumer Data, where we learning how to analyze consumer data to improve customer experience (R)
- taking ORGB 3201, Organizational Behavior, overview of the actions and behaviors of people in organizations (Case Studies)
